...
//1.250.000
echo $calculator->calculate(25000000)."<br>";
echo PHP_EOL;
//1.500.000
echo $calculator->calculate(30000000)."<br>"; 
echo PHP_EOL;
// 2.250.000
echo $calculator->calculate(45000000)."<br>"; 
echo PHP_EOL;
//2.500.0000
echo $calculator->calculate(50000000)."<br>"; 
echo PHP_EOL;
//4.000.000
echo $calculator->calculate(60000000)."<br>"; 
echo PHP_EOL;
//6.250.000
echo $calculator->calculate(75000000)."<br>"; 
echo PHP_EOL;
//32.500.000
echo $calculator->calculate(250000000)."<br>"; 
echo PHP_EOL;
//45.000.000
echo $calculator->calculate(300000000)."<br>"; 
echo PHP_EOL;
//82.500.000
echo $calculator->calculate(450000000)."<br>"; 
echo PHP_EOL;
//170.000.000
